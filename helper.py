...
class Penpencil:
    ...
    def __init__(self, token: str):
        #self.token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..x_gTcuJ_fih4oWrehaPFinMjx58YbXAMVb5lzRTk2_U"
        self.token = token
        self.headers = {
